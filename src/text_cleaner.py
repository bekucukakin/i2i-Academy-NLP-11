...
# The standard NLTK English stopword list, copied here as a literal so cleaning
# text never needs a network call or a separate nltk.download() step.
_NLTK_ENGLISH_STOP_WORDS = {
...
# Keep negation words in the cleaned text: "not good" carries the opposite
# meaning of "good", and TextBlob (and a human reader) relies on that.
_NEGATION_WORDS = {
    "no", "nor", "not", "don", "doesn", "didn", "isn", "aren", "wasn", "weren",
    "haven", "hasn", "hadn", "shouldn", "wouldn", "couldn", "mightn", "mustn",
    "needn", "won", "shan", "ain",
}

STOP_WORDS = _NLTK_ENGLISH_STOP_WORDS - _NEGATION_WORDS
